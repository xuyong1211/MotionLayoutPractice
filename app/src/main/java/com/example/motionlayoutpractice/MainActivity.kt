...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val rv2 = findViewById<RecyclerView>(R.id.rv_2)
        rv2.layoutManager = LinearLayoutManager(this,RecyclerView.VERTICAL,false)
        rv2.adapter = SimpleTextAdapter(arrayListOf("content_2","content_2","content_2","content_2","content_2","content_2"
                ,"content_2","content_2","content_2","content_2","content_2","content_2","content_2"))
